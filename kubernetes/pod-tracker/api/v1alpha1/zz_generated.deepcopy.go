...
func (in *PodToTrack) DeepCopyInto(out *PodToTrack) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodToTrack.
func (in *PodToTrack) DeepCopy() *PodToTrack {
	if in == nil {
		return nil
	}
	out := new(PodToTrack)
...
func (in *PodTrackerStatus) DeepCopyInto(out *PodTrackerStatus) {
	*out = *in
	...
	out.ExecutionTime = in.ExecutionTime
}
